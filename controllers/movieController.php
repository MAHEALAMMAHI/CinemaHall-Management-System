...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["delete_movie"])) {
        ...
        if (hasShowtimeForMovie($movieId)) {

            header("Location: ../views/staff/manage_movie.php?error=Cannot delete this movie because it has showtimes");
            exit();
            ...
            if (deleteMovie($movieId)) {
                ...
                header("Location: ../views/staff/manage_movie.php?success=Movie deleted successfully");
                exit();
